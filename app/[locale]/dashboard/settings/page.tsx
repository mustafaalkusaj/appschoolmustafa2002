...
type TabId = "branding" | "payroll" | "exports" | "printing" | "roles" | "dashboard-tab" | "year-end" | "archive";

const TABS: { id: TabId; label: string; icon: React.ElementType }[] = [
  { id: "branding", label: "الهوية البصرية", icon: Palette },
  { id: "payroll", label: "إعدادات الرواتب", icon: Settings },
