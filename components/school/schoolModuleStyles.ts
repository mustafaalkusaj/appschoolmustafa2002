...
export const SCHOOL_MODULE_CSS = `
      *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
      ...
      .topbar{background:white;padding:.7rem 1.4rem;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid rgba(22,137,201,0.08);flex-shrink:0;gap:.75rem;flex-wrap:wrap}
      ...
      .srch input{width:100%;padding:.55rem .8rem;background:white;border:1px solid rgba(22,137,201,0.12);border-radius:9px;font-family:var(--font-manrope),Segoe UI,sans-serif;font-size:.8rem;direction:rtl;outline:none}
      ...
      .btn-linkish{display:flex;align-items:center;gap:.4rem;padding:.55rem 1rem;background:#E6F6FF;color:var(--p3);border:1.5px solid rgba(22,137,201,0.25);border-radius:9px;font-family:var(--font-manrope),Segoe UI,sans-serif;font-size:.8rem;font-weight:700;cursor:pointer;white-space:nowrap;text-decoration:none}
      ...
      th{padding:.6rem .9rem;font-size:.72rem;font-weight:700;color:var(--p2);text-align:right;border-bottom:1px solid rgba(22,137,201,0.08)}
      td{padding:.6rem .9rem;font-size:.78rem;border-bottom:1px solid rgba(22,137,201,0.04);text-align:right}
      ...
      .fi,.fs{padding:.65rem .85rem;background:#F6FBFF;border:1.5px solid rgba(22,137,201,0.12);border-radius:9px;font-family:var(--font-manrope),Segoe UI,sans-serif;font-size:.82rem;direction:rtl;outline:none;width:100%}
      ...
      .pager button{padding:.4rem .75rem;border-radius:8px;border:1px solid rgba(22,137,201,0.2);background:white;cursor:pointer;font-size:.78rem;font-weight:600;font-family:inherit}
      ...
      .card{background:white;border-radius:12px;padding:1rem;border:1px solid rgba(22,137,201,0.08);box-shadow:0 2px 8px rgba(22,137,201,0.06)}
      ...
      .tab-mini{padding:.35rem .75rem;border-radius:8px;border:1px solid rgba(22,137,201,0.15);background:white;cursor:pointer;font-size:.75rem;font-weight:600}
